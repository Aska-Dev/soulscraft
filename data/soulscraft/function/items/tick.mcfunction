...
execute as @a at @s if items entity @s weapon.mainhand saddle[minecraft:custom_data={homeward_bone:true,souls_item:true,medium_charge:true}] if score @s soulsItemCharging matches 1.. run function soulscraft:items/homeward_bone/use_item_start
execute as @a[tag=itemChargeDone] at @s if items entity @s weapon.mainhand saddle[minecraft:custom_data={homeward_bone:true,souls_item:true,medium_charge:true}] run function soulscraft:items/homeward_bone/use_item

#Detec Skull lantern
execute as @a at @s if items entity @s weapon.* saddle[minecraft:custom_data={skull_lantern:true,souls_item:true,fast_charge:true}] if score @s soulsItemCharging matches 1.. run function soulscraft:items/skull_lantern/use_item_start
execute as @a[tag=itemChargeDone] at @s if items entity @s weapon.* saddle[minecraft:custom_data={skull_lantern:true,souls_item:true,fast_charge:true}] run function soulscraft:items/skull_lantern/use_item