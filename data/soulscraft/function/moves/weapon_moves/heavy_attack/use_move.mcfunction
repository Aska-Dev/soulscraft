...
execute at @s positioned ^ ^ ^2 anchored eyes at @e[distance=..2,tag=!sc.use.heavy_attack,type=#minecraft:mobs] run particle sweep_attack ~ ~ ~ 0 0 0 1 1 force
execute at @s positioned ^ ^ ^2 anchored eyes as @e[distance=..2,tag=!sc.use.heavy_attack,type=#minecraft:mobs] run damage @s 14 generic by @p[tag=sc.use.heavy_attack]
