...
execute as @a at @s if items entity @s weapon.mainhand saddle[minecraft:custom_data={homeward_bone:true,medium_charge:true,souls_item:true}] if score @s soulsItemCharging matches 1.. run function soulscraft:moves/homeward_bone/use_item_start
