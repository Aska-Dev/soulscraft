...
scoreboard players add @s soulInt 1
tellraw @s [{"color":"white","italic":false,"text":"Your mind grew stronger..."},{"color":"blue","text":" [Intelligence] "},{"color":"white","text":"increased to "},{"bold":true,"color":"aqua","score":{"name":"@s","objective":"soulInt"}}]