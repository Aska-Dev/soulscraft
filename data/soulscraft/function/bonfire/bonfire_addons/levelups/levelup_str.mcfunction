...
scoreboard players add @s soulStr 1
tellraw @s [{"color":"white","italic":false,"text":"You feel stronger..."},{"color":"dark_red","text":" [Strength] "},{"color":"white","text":"increased to "},{"bold":true,"color":"red","score":{"name":"@s","objective":"soulStr"}}]