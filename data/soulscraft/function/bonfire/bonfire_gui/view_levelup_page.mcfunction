...
execute if entity @s[tag=!soulscraftUsed] unless score @s soulscraftGui matches 4 run tellraw @p [{"color":"dark_purple","text":"Current soul tier: "},{"bold":true,"color":"light_purple","score":{"name":"@p","objective":"soulsLevelupTier"}}]
