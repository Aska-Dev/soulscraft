...
execute unless score @p[tag=sc.bonfire_user] sc.ring_slot.1 matches 1.. run item replace entity @s container.12 with white_stained_glass_pane[hide_tooltip={},hide_additional_tooltip={},custom_data={IsGuiItem:1}]
execute unless score @p[tag=sc.bonfire_user] sc.ring_slot.2 matches 1.. run item replace entity @s container.14 with white_stained_glass_pane[hide_tooltip={},hide_additional_tooltip={},custom_data={IsGuiItem:1}]
execute unless score @p[tag=sc.bonfire_user] sc.ring_slot.3 matches 1.. run item replace entity @s container.15 with white_stained_glass_pane[hide_tooltip={},hide_additional_tooltip={},custom_data={IsGuiItem:1}]

# Order rings if there is a missing slot
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.4 matches 1.. if score @p[tag=sc.bonfire_user] sc.ring_slot.3 matches 0 run function soulscraft:bonfire/bonfire_addons/rings/push_4_to_3
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.3 matches 1.. if score @p[tag=sc.bonfire_user] sc.ring_slot.2 matches 0 run function soulscraft:bonfire/bonfire_addons/rings/push_3_to_2
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.2 matches 1.. if score @p[tag=sc.bonfire_user] sc.ring_slot.1 matches 0 run function soulscraft:bonfire/bonfire_addons/rings/push_2_to_1

# Place rings in the right slots
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.1 matches 1.. run function soulscraft:bonfire/bonfire_addons/rings/setup_ring_slots
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.2 matches 1.. run function soulscraft:bonfire/bonfire_addons/rings/setup_ring_slots
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.3 matches 1.. run function soulscraft:bonfire/bonfire_addons/rings/setup_ring_slots
execute if score @p[tag=sc.bonfire_user] sc.ring_slot.4 matches 1.. run function soulscraft:bonfire/bonfire_addons/rings/setup_ring_slots
